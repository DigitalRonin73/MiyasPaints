...
const translations = {
  en: {
    ...
    gallerySuppliesAlt: "Pinto Beetle guests smiling with cherry blossom moon paintings",
  ...
  ja: {
    ...
    gallerySuppliesAlt: "桜と月の絵を持って笑うPinto Beetleの参加者の皆さん",
...
const classEvents = {
  "tropical-sunset": {
    image: "images/tropical-fireworks-artwork.jpg?v=20260524-16",
    imageAlt: {
