...
const translations = {
  en: {
    ...
    faqPrivateA: "I'd love to help you celebrate! Let's plan a memorable paint party for your special occasion.\n\nI mainly offer mobile pop-ups at your home, cafe, or venue. Cozy private space options are also available for small groups. Feel free to reach out!",
  ...
  ja: {
    ...
    faqPrivateA: "喜んでお手伝いします！お誕生日会や集まりなど、思い出になるアートパーティーを一緒に計画しましょう。\n\nご自宅やカフェなどへの出張（ポップアップ）がメインですが、少人数ならアットホームなプライベート空間での開催も可能です。お気軽にご相談ください。",
    reserveEyebrow: "予約",
