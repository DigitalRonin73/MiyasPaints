...
const translations = {
  en: {
    ...
    heroSubtitle: "Beginner-friendly acrylic painting classes for kids, adults, couples, and families in Yomitan.",
    heroNote: "Relax.\nUnplug.\nCreate & enjoy!",
    heroImageAlt: "Smiling Pinto Beetle class guests holding blue paintings",
    perPerson: "per person",
    supplies: "supplies included",
    quickInfoTitle: "Quick class details",
    infoBeginnerTitle: "Beginner Friendly",
    infoBeginnerText: "No experience needed. Miya guides every step at an easy pace.",
    ...
    infoSuppliesText: "Canvas, paint, brushes, and instruction are ready when you arrive.",
  ...
  ja: {
    ...
    infoBeginnerTitle: "初心者歓迎",
    infoBeginnerText: "経験は不要です。Miyaがやさしいペースで一歩ずつ案内します。",
    infoSmallTitle: "少人数クラス",
    infoSmallText: "質問や写真、会話を楽しめるリラックスした雰囲気です。",
    infoSuppliesTitle: "画材込み",
    infoSuppliesText: "キャンバス、絵の具、筆、レッスンをすべて用意しています。",
    classesEyebrow: "開催予定",
