...
const translations = {
  en: {
    ...
    infoSmallSubtitle: "Miya's table (up to 6 guests)",
    infoSmallText: "Small, relaxed classes for up to 6 guests in a welcoming table setting.",
    ...
    infoCustomSubtitle: "Birthdays, gatherings & mobile events",
  ...
  ja: {
    ...
    infoCustomTitle: "Custom Events & Workshops",
    infoCustomSubtitle: "お誕生日会・お仲間との集まり・出張イベント",
