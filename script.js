...
const translations = {
  en: {
    ...
    faqDrinkQ: "Can I bring my own drinks and snacks?",
    faqDrinkA: "Absolutely! Pour your favorite wine or beer, grab a snack, and just relax. That's the Pinto Beetle style.\n\nWe can also arrange snacks and drinks for you, so feel free to ask!",
  ...
  ja: {
    ...
    faqDrinkA: "もちろんです！お気に入りのワインやビール、おやつを片手にリラックスして描くのがPinto Beetleのスタイルです。こちらでもご用意してますが、リクエストがあれば事前にご相談ください。",
