...
const translations = {
  en: {
    ...
    galleryStudentAlt: "Ocean-view painting class room prepared with easels and supplies",
    galleryGroupAlt: "Pinto Beetle painting setup with canvas, paint, brushes, and snacks",
    gallerySuppliesAlt: "Guests working on paintings around the Pinto Beetle class table",
    galleryKidsAlt: "Pinto Beetle studio table ready for a cozy painting workshop",
    gallerySakuraAlt: "Canvas and painting supplies prepared for a Pinto Beetle class",
    galleryTurtleAlt: "Students enjoying an ocean-view Pinto Beetle painting class",
  ...
  ja: {
    ...
    galleryStudentAlt: "イーゼルと画材が用意された海の見えるペイント教室",
    galleryGroupAlt: "キャンバス、絵の具、筆、軽食が並ぶPinto Beetleのペイント準備",
    gallerySuppliesAlt: "Pinto Beetleのクラスのテーブルで作品を描く参加者たち",
    galleryKidsAlt: "あたたかい雰囲気のPinto Beetleワークショップ用テーブル",
    gallerySakuraAlt: "Pinto Beetleのクラス用に準備されたキャンバスと画材",
    galleryTurtleAlt: "海の見えるPinto Beetleのペイントクラスを楽しむ生徒たち",
