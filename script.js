...
const translations = {
  en: {
    ...
    infoSmallText: "Slow down and enjoy the moment.",
    infoCreativeTitle: "Create",
    infoCreativeText: "Create something uniquely yours.",
    ...
    sessionRequestEyebrow: "Request a Painting",
    sessionRequestTitle: "Have a painting in mind?",
    sessionRequestBody: "“I’d love to paint this one.”\n“I want to join with friends.”\n“This date works for me.”\n\nFeel free to send me a message.\n\nLet me know the painting you’d like to try and a few possible dates.\nI’ll do my best to arrange it.",
    sessionRequestButton: "Ask about a painting",
    sessionRequestSelected: "Painting request",
    sessionRequestMessage: "I’d like to ask about a painting.\n\nThe painting I’d like to try:\n\nPossible dates:\n1.\n2.\n3.",
    ...
    instructorLanguageNote: "English is not my first language, but I’ll do my best to make your experience enjoyable.",
    ...
    faqPriceA: "Classes are ¥4,500 / $30 per person, unless a special event lists a different price.",
    ...
    faqPrivateA: "Yes! I’d love to help make your gathering extra special.\n\nI can bring all painting supplies to your location for birthdays, family celebrations, private gatherings, and small group experiences.\n\nIf you already have a venue in mind, simply let me know your preferred date, location, and group size, and we’ll create something memorable together.",
    ...
    formSuccess: "Thanks! Your reservation request was sent. Miya will follow up with confirmation details.",
  ...
  ja: {
    ...
    infoSmallText: "日常を少し離れて、ゆったりとした時間を。",
    infoCreativeTitle: "Create",
    infoCreativeText: "世界にひとつだけの作品と思い出を。",
    ...
    stepTwoTitle: "席をリクエストする",
    stepTwoText: "リクエスト送信後、空き状況を確認して確定メールをお送りします。",
    ...
    instructorTitle: "Miya",
    instructorIntro: "初めての方でも安心して楽しめる、リラックスしたペイント体験をお届けしています。\n\n完成した作品はもちろん、自分らしいアイデアや色選びを楽しむ時間も大切にしています。\n\nその日に集まったメンバーとの一期一会のひとときも、この体験の魅力のひとつです。",
    instructorClosing: "絵の上手さよりも、自分らしく過ごすクリエイティブな時間を楽しんでいただけたら嬉しいです。",
    ...
    joinBeginners: "はじめてでも安心",
    joinExperience: "経験不要",
    joinNote: "カップル / 友人 / ファミリー",
    includedEyebrow: "料金に含まれるもの",
    includedTitle: "手ぶらでお越しください",
    includedCanvasPaints: "キャンバス＆絵の具",
    includedBrushesSupplies: "筆＆道具",
    includedApron: "エプロンあり",
    includedInstruction: "ステップごとのサポート",
    testimonialsEyebrow: "お客様の声",
    testimonialsTitle: "Reviews",
    testimonialOne: "「自分でもびっくり。\nお気に入りの作品ができました！」",
    testimonialOneName: "初参加ゲスト",
    testimonialTwo: "「絵を描くだけの時間じゃないって思いました。」",
    testimonialTwoName: "初参加ゲスト",
    testimonialThree: "「たくさん笑って、\n素敵な作品を持ち帰れました！」",
    testimonialThreeName: "参加ゲスト",
    notesEyebrow: "ご予約前に",
    notesTitle: "ご参加前に",
    ...
    faqPrivateQ: "特別なイベントや出張ペイントはできますか？",
    faqPrivateA: "はい、喜んでお手伝いします！\n\nお誕生日会や記念日、親子会などの特別なイベントはもちろん、カフェやレストラン、ご希望の会場への出張ペイントも承っています。\n\n画材や道具はすべてこちらで準備してお持ちしますので、会場をご用意いただくだけで大丈夫です。\n\n人数や内容によってご案内が異なりますので、ご希望の日時・場所・人数をお気軽にご相談ください。",
    ...
    sessionRequestEyebrow: "Request a Painting",
    sessionRequestTitle: "描いてみたい作品はありますか？",
    sessionRequestBody: "「この絵を描いてみたい」\n「友達と貸切で参加したい」\n「この日なら参加できる」\n\nそんな時はお気軽にご相談ください。\n\n作品やご希望日をお知らせいただければ、できる限り調整いたします。",
    sessionRequestButton: "相談してみる",
    sessionRequestSelected: "作品についてのご相談",
    sessionRequestMessage: "描いてみたい作品について相談したいです。\n\n描きたい作品：\n\n候補日時：\n1.\n2.\n3.",
