...
const translations = {
  ...
  ja: {
    ...
    instructorTitle: "Miya",
    instructorIntro: "初めての方でも安心して楽しめる、リラックスしたペイント体験をお届けしています。\n\n完成した作品はもちろん、自分らしいアイデアや色選びを楽しむ時間も大切にしています。\n\nその日に集まったメンバーとの一期一会の時間も、このクラスの魅力のひとつです。",
    instructorClosing: "絵の上手さよりも、あなたらしいクリエイティブな時間を楽しんでいただけたら嬉しいです。",
    ...
    sessionRequestTitle: "描きたい絵がありますか？",
    sessionRequestBody: "スケジュール以外の日程でも、内容や人数に応じて開催できる場合があります。\n\n「この絵を描いてみたい！」\n「この日なら参加できる！」\n\nそんなご希望がありましたら、お気軽にご相談ください。\n\n描きたい作品と候補日時を2〜3日ほどお知らせいただければ、できる限り調整いたします。",
