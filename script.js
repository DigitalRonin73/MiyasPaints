...
const translations = {
  en: {
    ...
    infoBeginnerTitle: "Creative Fun for All Ages",
    infoBeginnerText: "Art experiences kids, adults, friends, and families can enjoy together.",
    infoSmallTitle: "Custom Events & Workshops",
    infoSmallSubtitle: "Birthdays, gatherings & mobile events",
    infoSmallText: "Art experiences for birthdays, gatherings, mobile events, and other special moments.",
  ...
  ja: {
    ...
    infoBeginnerTitle: "Creative Fun for All Ages",
    infoBeginnerText: "キッズから大人まで、みんなで楽しめるアート体験を。",
    infoSmallTitle: "Custom Events & Workshops",
    infoSmallSubtitle: "お誕生日会・お仲間との集まり・出張イベント",
    infoSmallText: "お誕生日会、お仲間との集まり、出張イベントなど、特別なひとときを彩るアート体験をお手伝いします。",
    infoSuppliesTitle: "All Materials Included",
