...
const translations = {
  en: {
    ...
    faqPrivateA: "I'd love to help you celebrate! Let's plan a memorable paint party as a special activity for your birthday, anniversary, or gathering.\n\nI mainly offer mobile pop-ups at your home, cafe, or venue. Cozy private space options are also available for small groups. To ensure your preferred date, please feel free to reach out as early as possible!",
  ...
  ja: {
    ...
    faqPrivateA: "喜んでお手伝いします！お誕生日会や記念日の集まりなど、特別な日のアクティビティとして思い出になるアートパーティーを計画しましょう。\n\nご自宅やカフェなどへの出張（ポップアップ）がメインですが、少人数ならアットホームなプライベート空間での開催も可能です。ご希望の日時に合わせやすくなりますので、計画が決まりましたらお早めにご相談ください！",
    reserveEyebrow: "予約",
